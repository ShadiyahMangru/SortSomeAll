...
interface StatsTracking{
	...
	public static final String[] sortSomeAllOpts = {"Show ALL skaters in sorted order", "Show 5 lowest scores", "Show 5 highest scores", "Define your own 'bracket'"};
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class GoalieStats{
	//fields
	...
	public void skatersStatsMenu(){
		...
		case 1: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: 
				ArrayList<Integer>lowestFive = new ArrayList<Integer>();
				lowestFive.add(skaterStat.get(0).getStats().getGoals());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getGoals()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getGoals());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " goals:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getGoals()).equals(lowestFive.get(i)) == true){
				...
				break;
			case 3: ArrayList<Integer>highestFive = new ArrayList<Integer>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getGoals());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getGoals()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getGoals());
						}
					
				}
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " goals:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getGoals()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
		...
		case 2: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Integer>lowestFive = new ArrayList<Integer>();
				lowestFive.add(skaterStat.get(0).getStats().getAssists());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getAssists()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getAssists());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " assists:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getAssists()).equals(lowestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
			...
			case 3: ArrayList<Integer>highestFive = new ArrayList<Integer>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getAssists());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getAssists()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getAssists());
						}
					
				}
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " assists:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getAssists()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
		...
		case 3: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Integer>lowestFive = new ArrayList<Integer>();
				lowestFive.add(skaterStat.get(0).getStats().getPoints());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getPoints()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getPoints());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " points:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getPoints()).equals(lowestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
			...
			case 3: ArrayList<Integer>highestFive = new ArrayList<Integer>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getPoints());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getPoints()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getPoints());
						}
					
				}
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " points:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getPoints()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
		...
		case 4: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Integer>lowestFive = new ArrayList<Integer>();
				lowestFive.add(skaterStat.get(0).getStats().getPlusMinus());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getPlusMinus()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getPlusMinus());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " +/-:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getPlusMinus()).equals(lowestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
			...
			case 3: ArrayList<Integer>highestFive = new ArrayList<Integer>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getPlusMinus());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getPlusMinus()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getPlusMinus());
						}
				...
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " goals:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getPlusMinus()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
		...
		case 5: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Integer>lowestFive = new ArrayList<Integer>();
				lowestFive.add(skaterStat.get(0).getStats().getShots());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getShots()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getShots());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " shots:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getShots()).equals(lowestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
			...
			case 3: ArrayList<Integer>highestFive = new ArrayList<Integer>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getShots());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getShots()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getShots());
						}
					
				}
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " shots:  ");
					for(Skater sk : skaterStat){
						if(((Integer)sk.getStats().getShots()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
		...
		case 6: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Double>lowestFive = new ArrayList<Double>();
				lowestFive.add(skaterStat.get(0).getStats().getShootingPercentage());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getShootingPercentage()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getShootingPercentage());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " shooting percentage:  ");
					for(Skater sk : skaterStat){
						if(((Double)sk.getStats().getShootingPercentage()).equals(lowestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
				...
				break;
			case 3: ArrayList<Double>highestFive = new ArrayList<Double>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getShootingPercentage());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getShootingPercentage()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getShootingPercentage());
						}
					
				}
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " shooting percentage:  ");
					for(Skater sk : skaterStat){
						if(((Double)sk.getStats().getShootingPercentage()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
		...
		case 7: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Double>lowestFive = new ArrayList<Double>();
				lowestFive.add(skaterStat.get(0).getStats().getAvgPtsGP());
				for(Skater sk : skaterStat){
					
						if(lowestFive.contains(sk.getStats().getAvgPtsGP()) != true & lowestFive.size() <= 4){
							lowestFive.add(sk.getStats().getAvgPtsGP());
						}
					
				}
				for(int i = 0; i< lowestFive.size(); i++){
					System.out.print(lowestFive.get(i) + " points per games played:  ");
					for(Skater sk : skaterStat){
						if(((Double)sk.getStats().getAvgPtsGP()).equals(lowestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
			...
			case 3: ArrayList<Double>highestFive = new ArrayList<Double>();
				Collections.reverse(skaterStat);
				highestFive.add(skaterStat.get(0).getStats().getAvgPtsGP());
				for(Skater sk : skaterStat){
					
						if(highestFive.contains(sk.getStats().getAvgPtsGP()) != true & highestFive.size() <= 4){
							highestFive.add(sk.getStats().getAvgPtsGP());
						}
					
				}
				for(int i = 0; i< highestFive.size(); i++){
					System.out.print(highestFive.get(i) + " points per games played:  ");
					for(Skater sk : skaterStat){
						if(((Double)sk.getStats().getAvgPtsGP()).equals(highestFive.get(i)) == true){
							System.out.print(sk.getLastName() + ", ");	
						}
					}
					System.out.println();
